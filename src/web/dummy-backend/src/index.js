...
const inspectorData = [
  ...
  },
  {
    ...
    lastName: "Doe",
    status: "INACTIVE",
    location: { latitude: 32.8967, longitude: -96.8200 },
    badgeNumber: "B12346",
    certifications: [
      {
        id: 2,
  ...
  },
  {
    ...
    lastName: "Johnson",
    status: "AVAILABLE",
    location: { latitude: 32.9552, longitude: -96.8270 },
    badgeNumber: "B12347",
    certifications: [
      {
        id: 3,
  ...
  },
  {
    ...
    lastName: "Brown",
    status: "AVAILABLE",
    location: { latitude: 33.1234, longitude: -96.7890 },
    badgeNumber: "B12349",
    certifications: [
      {
        id: 5,
...
app.put('/api/v1/equipment/assignments/:id/return', (req, res) => {
  ...
  const assignment = assignments.find(a => 
    a.equipmentId === parseInt(req.params.id) && 
    a.status === 'active'
  );
...
app.get('/api/v1/inspectors/search', (req, res) => {
  ...
  if (isActive !== undefined && isActive !== null) {
    ...
    filteredInspectors = filteredInspectors.filter(inspector => 
      inspector.isActive === isActiveBoolean
    );
  }
  ...
  if (certifications) {
    ...
    filteredInspectors = filteredInspectors.filter(inspector =>
      inspector.certifications.some(cert =>
        requiredCerts.includes(cert.name) && cert.isActive
      )
    );
  }
  ...
  if (latitude !== undefined && longitude !== undefined && radiusInMiles) {
    ...
    const lon = parseFloat(longitude) || -96.7970;
...
app.get('/api/v1/customers', (req, res) => {
  ...
  if (region) {
    filteredCustomers = filteredCustomers.filter(customer =>
      customer.region.toLowerCase() === region
    );
  }
